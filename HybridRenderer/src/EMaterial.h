#ifndef ELITE_MATERIAL
#define ELITE_MATERIAL
...
namespace Elite
{
	...
	public:
		...
		//Workers
		/*Software*/
		virtual RGBColor Shade(const VertexOutput& v, const FVector3& lightDirection, const FVector3& viewDirection, const FVector3& normal) const = 0;

		//Setters
		/*D3D*/
		virtual void SetMaps() = 0;
		virtual void SetMatrices(const FMatrix4& projectionMat, const FMatrix4& inverseViewMat /*This is the OBN*/, const FMatrix4& worldMat) = 0;
